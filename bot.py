...
def set_webhook():
    ...
    webhook_url = os.environ.get("url=https://final-hester-notcrazyhuman-94126448.koyeb.app/") https://api.telegram.org/bot<YOUR_BOT_TOKEN>/setWebhook  # e.g., https://your-koyeb-app.koyeb.app/webhook/<token>
    bot = dispatcher.bot
    if webhook_url:
