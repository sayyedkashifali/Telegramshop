...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        if 5 <= current_hour < 12:
            ...
            greeting = "Good afternoon ☀️ Have a productive and happy day!"
        elif 18 <= current_hour < 23:
            greeting = "Good evening 🌃 Have a relaxing evening!"
        else:
            greeting = "Good night 🌙 Sweet dreams, have a peaceful night."
